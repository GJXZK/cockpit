...
<template>
  <div class="w-full h-full">
    ...
    <div class="frame-bg flex flex-wrap">
      <LiquidFill
        title="状态监测功能"
        :value="systemAvailabilityData?.status_detection"
      ></LiquidFill>
      <LiquidFill
        title="自主寻优功能"
        :value="systemAvailabilityData?.self_optimization"
      ></LiquidFill>
      <LiquidFill
        title="冷端优化功能"
        :value="systemAvailabilityData?.cold_end_optimization"
      ></LiquidFill>
      <LiquidFill
        title="寻优控制功能"
        :value="systemAvailabilityData?.optimization_control"
      ></LiquidFill>
    </div>
  </div>
</template>
